        ...
        <div className="relative bg-center" style={{ backgroundImage: `url(${banner})` }}>
            <div className="relative z-10 flex flex-col md:flex-row items-center justify-between px-8 h-full overflow-hidden">
                <div className=" max-w-2xl mb-6 md:mb-0">
                    <h1 className="lg:text-5xl md:text-3xl text-[#130f40] font-bold mb-4">Safeguarding Health</h1>
                    <h1 className="lg:text-5xl md:text-3xl text-[#130f40] font-bold mb-4">with Vaccination</h1>
                    <h1 className="lg:text-5xl md:text-3xl text-[#130f40] font-bold mb-4">Programs</h1>
                    <p className="md:text-lg text-[#525252] mb-6">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Suscipit eaque dignissimos officiis repellendus optio mollitia magni quam dolorum praesentium enim.</p>
