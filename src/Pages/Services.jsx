...
const Services = () => {
    return (
        <div style={{ backgroundImage: `url(${servicesbg})` }} className='px-8 bg-cover bg-center '>
            <div className='py-5'>
                ...
                <div className='grid  lg:grid-cols-3  gap-5'>
                    <div className="bg-white bg-opacity-70 p-10 rounded-lg text-center shadow-lg max-w-sm mx-auto transform transition-transform hover:-translate-y-2">
                        <div className="mb-4">
